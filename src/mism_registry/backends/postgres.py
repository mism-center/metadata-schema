...
class ResourceModel(Base):
    ...
    execution_type: Mapped[str | None] = mapped_column(String(20), nullable=True)
...
def resource_from_db(model: ResourceModel) -> Resource:
    ...
    return Resource(
        ...
        execution_type=ExecutionType(model.execution_type) if model.execution_type else None,
